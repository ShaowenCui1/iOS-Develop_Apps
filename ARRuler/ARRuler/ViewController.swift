...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    func calculate(){
        ...
        updateTest(text: String(format: "%.2f", distance) + "m",atPosition: end.position)
    }
    
    
    func updateTest(text: String, atPosition position: SCNVector3) {
